...
<header>
	...
	<div class="menu">
		<ul>
			...
			<li class="menu-item hidden"><a href="https://ci-rest-jwt.herokuapp.com/">Home</a></li>
			<li class="menu-item hidden"><a
					href="https://github.com/mdestafadilah/ci-rest-jwt/pulls" target="_blank">Github Pulls</a>
			</li>
		</ul>
	</div>
	...
	<div class="heroe">
		...
		<h1>Welcome to REST JWT with CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
